        ...
        <div className="flex-1 min-h-0 grid gap-3 bento-grid"
          ...
          */}
          ...
          <div className="rounded-2xl flex flex-col overflow-hidden leaderboard-panel"
            ...
            {/* Liste pleine hauteur — tous les 15 joueurs visibles */}
            <div style={{flex:1,overflowY:"auto",scrollbarWidth:"none",padding:"4px 18px 14px",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
              {leaderboard.slice(0,15).map((e,i)=>{
                ...
                return(
                  <div key={e.id} style={{
                    ...
                    padding:"5px 0",
                    borderBottom:i<14?"1px solid rgba(8,18,52,0.052)":"none",
                    minHeight:0,flex:"1 0 0",
                  }}>
                    <span style={{
                      fontWeight:900,width:22,flexShrink:0,textAlign:"center",
                      fontSize:i<3?"0.78rem":"0.58rem",
                      color:"rgba(8,18,52,0.28)",
                    }}>
                      {i<3?medals[i]:i+1}
                    </span>
                    <span style={{
              ...
              {!leaderboard.length&&(
                <div style={{fontWeight:700,textAlign:"center",padding:"24px 0",fontSize:"0.58rem",
                  letterSpacing:"0.3em",color:"rgba(8,18,52,0.25)",textTransform:"uppercase"}}>aucune donnée</div>
              )}
            </div>
          </div>
